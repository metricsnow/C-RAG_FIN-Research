...
class TestSaveFilingsToFiles:
    ...
    def test_save_filings_to_files_success(self, tmp_path):
        ...
        documents = [
            Document(page_content="Content 1", metadata={"filename": "file1.txt"}),
            Document(page_content="Content 2", metadata={"filename": "file2.txt"}),
        ]
    ...
    def test_save_filings_to_files_missing_filename(self, tmp_path):
        ...
        documents = [
            Document(page_content="Content", metadata={}),  # No filename
        ]
